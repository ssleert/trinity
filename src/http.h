...
#define ALLOW_METHODS_HEADER "Access-Control-Allow-Methods: GET, POST, OPTIONS, PUT, DELETE"
#define ALLOW_HEADERS_HEADER "Access-Control-Allow-Headers: Content-Type, Authorization"
